# -*- coding: utf-8 -*-
"""`SpeedValueBaotouV20`（V 剂量档 20）的契约用例 —— R1371。
...
from bot.speedvaluebaotouv import SpeedValueBaotouV20            # noqa: E402


class TestSpeedValueBaotouV20(dose_case(SpeedValueBaotouV20, 20.0)):
    """该剂量档的契约（用例从共享工厂生成）。"""
