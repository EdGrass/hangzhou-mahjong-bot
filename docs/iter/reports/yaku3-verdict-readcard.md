...
| `speedvaluebaotouv5` | 和牌率/房 **z≥1.50** | 番/房 **候选 > 基线**（campaign7 §2：**只看方向**，"本轴的全部理由就是赢得大"） | **爆头/胡 与 番/胡 都上升**（足迹只是必要条件） |
...
| `speedvaluebaotouv5` | **爆头/胡 与 赢分/胡 两者均上升**（同房口径）；护栏：**胡率不得低于基线 1σ** | `var/_seat_h2h.py --by-arm --top 32` + `tools/hu_gap_split.py --by-arm` |
